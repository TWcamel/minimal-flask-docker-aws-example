...
import config.config as mysql_config
...
class DB:
    def __init__(self):
        ...
        """
        with mysql_config.Config() as _config:
            CONFIG = _config.get_mysql_config()

        self._cnx = mysql.connector.connect(
            pool_size=10,  # maximum -> pooling.CNX_POOL_MAXSIZE
